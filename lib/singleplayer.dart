...
class singleplayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold( backgroundColor: Colors.white,
      ...
      body:
      StreamBuilder(
          stream: FirebaseFirestore.instance.collection('Games').doc(_auth.currentUser?.email).snapshots(), //counterStream,
                  ...
                  ListView(
                    children: <Widget>[
                        ...
                        child:Row(
                          ...
                          children: <Widget>[
                            Column(children: <Widget>[IconButton(
                              ...
                              tooltip: 'Reset',
                              onPressed: () {
                                if(_auth.currentUser?.email==hostplayer) {_resetGame(_auth.currentUser?.email,PositionBlueI,PositionBlueJ,PositionRedI,PositionRedJ,PositionGreenI,PositionGreenJ,PositionYellowI,PositionYellowJ);}
                              },
                            ),
                              Text('Reset')]),
                            Column(children: <Widget>[IconButton(
                              ...
                              tooltip: 'Next Round',
                              onPressed: () {
                                if(_auth.currentUser?.email==hostplayer) {_nextRound(_auth.currentUser?.email,GameRound,lowestbidder,PositionBlueI,PositionBlueJ, PositionRedI, PositionRedJ, PositionGreenI, PositionGreenJ, PositionYellowI, PositionYellowJ);}
                              },
                            ),
                              Text('NextRound')]),
                      ...
                      StreamBuilder<QuerySnapshot>(
                          stream: FirebaseFirestore.instance.collection('Games/'+(_auth.currentUser?.email)!+'/Collectibles').where("Round",isEqualTo: GameRound).snapshots(), //.doc(_auth.currentUser.email).get(),
                      ...
                      StreamBuilder<QuerySnapshot>(
                          stream: FirebaseFirestore.instance.collection('Games/'+(_auth.currentUser?.email)!+'/Players').where("isHost",isEqualTo: true).snapshots(), //.doc(_auth.currentUser.email).get(),
